...
# --- 동작 설정 ---
# 비용 다이어트 (2026-09-17) — 출력 토큰이 전체 비용의 73%였다.
# 9/3~9/16 실측: 입력 평균 17,356 / 출력 평균 9,622 tok, max_tokens(12,000)에 6/14일이 90% 이상 근접.
# 9/7은 출력이 정확히 12,000에 닿아 JSON이 잘리고 그날 다이제스트가 통째로 날아갔다.
LOOKBACK_HOURS = 48   # 매일 도니 72시간은 중복 후보만 늘린다 (72 → 48)
